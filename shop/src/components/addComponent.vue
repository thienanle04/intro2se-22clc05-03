<template>
    <div class="card">
        ...
        <div class="row d-flex align-items-center mb-3">
            ...
            <div class="col-7">
                <input type="number" class="form-control" v-model.number="book.price" placeholder="Price"
                    aria-label="Price">
            </div>
        </div>
        <div class="row d-flex align-items-center mb-3">
            ...
            <div class="col-7">
                <input type="text" class="form-control" v-model="book.image" placeholder="Image URL"
